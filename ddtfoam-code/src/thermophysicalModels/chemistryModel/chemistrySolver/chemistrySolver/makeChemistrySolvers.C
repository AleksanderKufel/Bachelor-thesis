...
// ********************************** //
    ...
    makeChemistrySolver(ePsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(EulerImplicit, ePsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(ode, ePsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(sequential, ePsiChemistryModel, gasThermoPhysics)

    makeChemistrySolver(ePsiChemistryModel, icoPoly8ThermoPhysics)
    makeChemistrySolverType
    (
        EulerImplicit,
        ePsiChemistryModel,
    ...
    makeChemistrySolverType(ode, ePsiChemistryModel, icoPoly8ThermoPhysics)
    makeChemistrySolverType
    (
        sequential,
        ePsiChemistryModel,
...
// ********************************** //
    ...
    makeChemistrySolver(hPsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(EulerImplicit, hPsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(ode, hPsiChemistryModel, gasThermoPhysics)
    makeChemistrySolverType(sequential, hPsiChemistryModel, gasThermoPhysics)

    makeChemistrySolver(hPsiChemistryModel, icoPoly8ThermoPhysics)
    makeChemistrySolverType
    (
        EulerImplicit,
        hPsiChemistryModel,
    ...
    makeChemistrySolverType(ode, hPsiChemistryModel, icoPoly8ThermoPhysics)
    makeChemistrySolverType
    (
        sequential,
        hPsiChemistryModel,
