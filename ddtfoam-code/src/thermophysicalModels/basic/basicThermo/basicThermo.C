...
/*
//Foam::tmp<Foam::scalar> Foam::basicThermo::h
Foam::scalar Foam::basicThermo::h
(
    const scalar& Tgiven,
    label& cell
) const
{
    ...
    Info << " Ich hab's in hPsiThermo implementiert" << endl;
...
/*
Foam::tmp<Foam::volScalarField> Foam::basicThermo::e
(
...
*/
/*
Foam::tmp<Foam::scalarField> Foam::basicThermo::eFromT
(
    const scalarField& T
) const
{
...
/*
void Foam::basicThermo::test()
{
    Info << " testing basicThermo " << endl;
}
*/
